...
export function StepCard({
  ...
  useNow(snapshot.thinkingPauseUntil || snapshot.breakEndsAt || snapshot.lockInWarningStartedAt ? 1000 : 30_000);
  async function action(type: "done" | "thinking" | "markDone" | "keepWorking" | "endBreak" | "repeatRoutine") {
    ...
    return (
      <section className={`step-card ${compact ? "compact" : ""}`}>
        ...
        <CatMascot
          ...
          message={t("breakTime")}
          timerText={timeLeft(snapshot.breakEndsAt)}
