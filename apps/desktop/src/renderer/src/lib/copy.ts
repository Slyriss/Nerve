...
const copy: Record<"en" | "zh", Record<CopyKey, string>> = {
  en: {
    ...
    lockInBack: "I'm back",
    lockInWarningTitle: "Back to the task",
    lockInWarningBody: "Lock-in mode noticed drift. Return now to avoid the full-screen blocker.",
  ...
  zh: {
    ...
    lockInBack: "我回来了",
    lockInWarningTitle: "回到任务",
    lockInWarningBody: "锁定模式检测到走神。现在回来，就不会触发全屏拦截。",
