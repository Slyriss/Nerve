...
export type CopyKey =
  | "privateCopilot" | "session" | "settings" | "closeApp" | "runningSideTab" | "handoffBody"
  ...
  | "cancelThinking" | "delay" | "thinkingHold" | "completeCount" | "routine" | "repeatRoutine"
  ...
  | "deleteScheduledItem" | "deleteScheduledItemConfirm"
